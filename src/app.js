...
app.use(express.json()); // middle ware used to set the to accept json data with the limit of 100kb
app.use(express.urlencoded({ extended: true })); // middle ware use to parse the url, extended is used for nested objects
